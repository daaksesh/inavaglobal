...
export default function Contact() {
  const BOOKINGS_HEIGHT = 1000; // adjust if needed
          ...
          <div className="grid lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-6 flex">
              <div className="rounded-3xl ring-1 ring-slate-200 bg-white p-8 shadow-sm flex-1 flex flex-col">
                ...
                <form
                  className="mt-6 grid sm:grid-cols-2 gap-4 flex-1"
            ...
            <div className="lg:col-span-6 flex">
              <div className="rounded-3xl ring-1 ring-slate-200 bg-white p-8 shadow-sm flex-1 flex flex-col">
                ...
                <div className="mt-4 flex-1">
                  <iframe
                    src="https://outlook.office.com/book/FreeConsultationwithInavaGlobal@inavaglobal.com/?ismsaljsauthenabled=true"
                    width="100%"
                    height={BOOKINGS_HEIGHT}
                    frameBorder="0"
                    scrolling="yes"
                    className="rounded-xl"
                    title="Microsoft Bookings – INAVA Global"
                  />
                </div>

                <div className="mt-4">
                  <a
                    href="https://outlook.office.com/book/FreeConsultationwithInavaGlobal@inavaglobal.com/"
                    target="_blank"
